...
if __name__ == "__main__":
    saved_dir = r"D:\DOWNLOAD\ZALO_CHALLENGE\new\roadbuddy_sf\src\video"  # Change to your desired save directory
    # download_video_in_file(saved_dir=saved_dir, json_file="public_test/public_test.json")
    download_video_in_file(saved_dir=saved_dir, json_file="src/video/train/train.json")